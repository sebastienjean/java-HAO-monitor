...
public class JsonFileTokensRemoverPeriodicService extends AbstractTextFileTransformationPeriodicService
{
	...
	public void serve()
	{
		...
		// String destPath = inputFile.getAbsolutePath().substring(0,
		// inputFile.getAbsolutePath().lastIndexOf('.')) +destSuffix;
		...
		while (true)
		{
			...
			{
				// no use to do something special here, just let line remain
				// null
			}
			if (line == null)
				break;
