...
import fr.iutvalence.hao.flight.ubpe2014.services.UBPE2014JsonProducerDataEventListenerService;
...
public class UBPE2014WebFrontEndLauncher
{
	/**
	 * Application's main.
	 * 
	...
	public static void main(String[] args)
	{
		...
		UBPEDataEventParserForwarder ubpe2014Parser = new UBPEDataEventParserForwarder(fr.iutvalence.hao.flight.ubpe2014.data.UBPE2014DataEvent.class, "UBPE2014");
		...
		System.out.println("Creating ubpe2014 JSON producer service ...");
		UBPE2014JsonProducerDataEventListenerService runnableWebJsonListener = new UBPE2014JsonProducerDataEventListenerService(new File(args[2]), "UTF-8");
		System.out.println("... done");

		System.out.println("Registering ubpe2014 JSON producer service as a parser listener ...");
		ubpe2014Parser.registerDataEventListener(runnableWebJsonListener);
		System.out.println("... done");

		System.out.println("Starting ubpe2014 JSON producer service ...");
