package fr.iutvalence.hao.flight.ubpe2015.main;
...
import fr.iutvalence.hao.flight.ubpe2015.services.UBPE2015JsonProducerDataEventListenerService;
...
public class UBPE2015WebFrontEndLauncher
{
	/**
	 * Application's main.
	 * 
	...
	public static void main(String[] args)
	{
		...
		System.out.println("Creating and registering ubpe2015 event parser ...");
		UBPEDataEventParserForwarder ubpe2015Parser = new UBPEDataEventParserForwarder(fr.iutvalence.hao.flight.ubpe2015.data.UBPE2015DataEvent.class, "UBPE2015");
		Map<String, DataEventParserForwarder> parsers = new HashMap<String, DataEventParserForwarder>();
		parsers.put("UBPE2015", ubpe2015Parser);
		...
		System.out.println("Creating ubpe2015 JSON producer service ...");
		UBPE2015JsonProducerDataEventListenerService runnableWebJsonListener = new UBPE2015JsonProducerDataEventListenerService(new File(args[2]), "UTF-8");
		System.out.println("... done");

		System.out.println("Registering ubpe2015 JSON producer service as a parser listener ...");
		ubpe2015Parser.registerDataEventListener(runnableWebJsonListener);
		System.out.println("... done");

		System.out.println("Starting ubpe2015 JSON producer service ...");
