package fr.iutvalence.hao.flight.ubpe2017.data;
...
public class UBPE2017DataEvent extends AbstractDataEvent
{

	public UBPE2017DataEvent(byte[] ubpeFrame)
	{
		this(ubpeFrame, new HashMap<String, MetadataField>());
		UBPE2017Data data = (UBPE2017Data) (this.getParsedData());
	...
	public UBPE2017DataEvent(byte[] ubpeFrame, Map<String, MetadataField> metadataFields)
	{
	...
	{
		UBPE2017Data parsedEvent = null;
		try
		{
			parsedEvent = new UBPE2017Data(this.getRawData());
			// Extract objectName
			return parsedEvent;
		}
	...
	{
		String result = "UBPE2017DataEvent\n";
		try
		{
