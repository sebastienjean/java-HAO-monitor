 ...
 * <br/>
 * This TCP server reads data frames received from the HAO and relayed by
 * stations.<br/>
 * 
 * Application protocol is pretty simple:
 * <ul>
 * <li>
 * Communication model is simplex (client to server only)</li>
 * <li>
 * The client sends a unique line of ASCII-encoded text, formatted as follows <br>
 * / <tt>eventType@clientName#eventData</tt> <br/>
 * </li>
 * </ul>
 * 
 */
public class WebFrontEndWelcomeService extends AbstractService
{
	...
	public void serve()
	{
		// Nothing to do here, it is a fake service. The service paradigm is
		// only used
